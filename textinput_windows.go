...
func (w *TextInput) Mount(parent NativeWidget) (MountedWidget, error) {
	...
	win.SetWindowLongPtr(hwnd, win.GWLP_WNDPROC, syscall.NewCallback(editWindowProc))
...
func editWindowProc(hwnd win.HWND, msg uint32, wParam uintptr, lParam uintptr) (result uintptr) {
	switch msg {
	case win.WM_DESTROY:
